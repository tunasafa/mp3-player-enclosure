...
The compact repack turns the same battery to 30 mm across × 40 mm along × 5 mm deep, centered at X −11.2, Y −3 mm. Those are the supplied listing dimensions; no exact manufacturer datasheet, finished-pack maxima or protection-board geometry has been provided. The connector is likely a PH 2.0 plug, but polarity is not standardized across vendors and must be checked on the actual pack before connection. The CAD reserves an 8 × 10 × 5 mm connector pocket at X 18, Y 26, Z 5.1 mm, above the XIAO and connected to the upper routing bridge. Its adequacy still depends on the actual plug and wire exit; rendered leads and flex are illustrative routes, not measured harnesses. The reduced case leaves 1.7 mm behind the nominal cell, down from 2.0 mm. That is a design allowance, not a certified expansion requirement.
...
The current 12.9 mm shell places the battery entirely below the LCD, behind the wheel, and the flipped DAC at the upper left. Components face the rear, with the headphone socket at the top. The full 7.1 mm published DAC height, 0.3 mm depth gaps and original 1.7 mm battery rear allowance are retained. The gain over 13.1 mm comes from a local 1.0 mm LCD seat floor and a wheel seat lowered 0.2 mm, not from shrinking the boards or compressing the battery. Both face orientations fit at this location; the selected one is Y-flipped relative to the original 13.1 mm layout. Manufacturer CAD puts the headphone axis at X-13.359, Z8.1725, with its mouth 0.05 mm inside the top face. The 5 mm circular aperture surrounds the 4.6 mm barrel. Three rear locating posts use actual mounting holes and leave 0.2 mm for insulating adhesive on their PCB lands. Fit the real board, solder joints, adhesives and plug before accepting the mounts. The LCD pocket's stiffness and near-flush wheel/button motion need physical tests. No port or seam is sealed. See [current arrangement and fit limits](README.md) and [vendor evidence](vendor/README.md). Direct solder wiring, controlled return paths and strain relief remain required; reserves are not a routed or electrically tested harness.
