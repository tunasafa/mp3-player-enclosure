...
const poses={iso:[125,130,-185],front:[0,0,-235],rear:[0,0,235],side:[235,0,4]};
function view(name){camera.position.set(...poses[name]);controls.target.set(0,0,4);controls.update();}
